...
> Modern Android application for MicroHabit Quest.

**Gamified Habit / RPG** built with Kotlin and modern Android development standards.

---

## 🚀 Features

- **Core Functionality**: Streamlined workflows and tools for MicroHabit Quest.
- **Modern UI**: Built using Material Design 3 and Jetpack Compose.
- **Offline First**: Local storage with Room and DataStore.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/hsinidev/MicroHabit-Quest.git
   cd MicroHabit-Quest
   ```
